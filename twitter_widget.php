...
/**
 * Plugin Name: Tweets Rotator 2013
 * Plugin URI: http://themefantasy.com/plugin/
 ...
 <?php
    ...
    <script>
      ...
      */
      ...
      twitterFetcher.fetch('<?php echo $twitter_id; ?>', 'tweets', <?php echo $limit; ?>, true);
...
function mytwitter_widget_init(){
	...
	add_action('wp_print_styles', 'mytwitter_widget_load_css');
...
function mytwitter_widget_load_css(){
	...
	wp_enqueue_style('wpmega-basic', 	$tmp.'css/style.css', 					false, '1.1', 'all');
